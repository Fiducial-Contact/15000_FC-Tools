...
echo "  - Configuration: $DATASET_DIR/dataset.toml"
echo ""
echo "Next steps:"
echo "  1. Add more images/videos if needed"
echo "  2. Create .txt caption files for each media file"
echo "  3. Review and adjust dataset.toml if needed"
echo "  4. (Optional) Run ./pre_cache_dataset.sh to speed up training"
echo "  5. Run ./train_wan22_lora.sh to start training"
echo ""
echo "Tips:"
echo "  - Use at least 20-50 images for good results"
echo "  - Ensure consistent style across your dataset"
echo "  - Include your trigger phrase in all captions"
echo "  - See caption_examples.txt for caption writing tips"